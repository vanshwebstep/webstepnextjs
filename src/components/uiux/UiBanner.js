            ...
            <div className="lg:w-3/5">
              <div className="mb-10 text-center lg:text-left">
                ...
                <p className="text-slate-500 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
                  We create visually stunning and highly intuitive interfaces that engage users and
                  drive conversions. Our design process focuses on{" "}
                  <span className="text-slate-900 font-semibold">user research, empathy, and technical feasibility.</span>
                </p>
