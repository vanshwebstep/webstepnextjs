            ...
            <div className="lg:w-3/5">
              <div className="mb-10">
                ...
                <div className="space-y-5 text-slate-500 text-lg leading-relaxed">
                  <p>
                    Great design is not just about how something looks, but how it works. Our UI/UX
                    design process is rooted in deep user research and strategic thinking to ensure
                    your product resonates with your audience.
                  </p>
                  <p>
                    From wireframing and prototyping to final visual design and hand-off, we work
                    closely with your team to create a product that is beautiful, functional, and
                    aligned with your business goals.
                  </p>
                  <p>
                    We specialize in creating design systems that are scalable, accessible, and
                    maintainable, ensuring a{" "}
                    <span className="text-slate-900 font-semibold">consistent brand experience</span>{" "}
