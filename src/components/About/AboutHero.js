...
const AboutHero = () => {
  ...
  return (
    <>
      <section className="relative w-full py-[8.8rem] pb-20 overflow-hidden bg-slate-50 font-roboto">
        ...
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-br from-pink-500/10 to-orange-500/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-pink-500/5 to-transparent rounded-full blur-[80px] translate-y-1/2 -translate-x-1/3" />
          ...
          <AnimatedSection delay={0.1} direction="up">
            <div className="text-center flex flex-col items-center">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-2xl mt-8 mb-4 border border-white/60 bg-white/50 backdrop-blur-xl shadow-sm text-[11px] font-bold tracking-[0.3em] uppercase"
                style={{ color: "#FF1F8E" }}
              >
              ...
              >
                <a href="#process"
                  className="group flex items-center gap-2 px-8 py-4 rounded-2xl font-bold text-white text-[15px] transition-all duration-300 hover:scale-105"
                ...
                <a href="/customize-package"
                  className="flex items-center gap-2 px-8 py-4 rounded-2xl font-bold text-slate-600 text-[15px] border border-slate-200 hover:border-purple-300 hover:text-purple-600 bg-white/60 backdrop-blur-md transition-all duration-300">
                  Start a Project
                </a>
              </motion.div>
