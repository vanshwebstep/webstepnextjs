      ...
      >
        ...
        <div className="flex-1 min-w-0 group transition-all duration-300">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <span
              className="text-[11px] font-semibold uppercase tracking-[0.25em] px-3 py-1 rounded-full"
          ...
          <div className="mt-4 h-[2px] w-10 transition-all duration-300 group-hover:w-20" style={{ backgroundColor: service.accent }} />
        </div>
        ...
        {/* ✅ CTA Arrow — now links to the correct service detail page */}
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <div ref={headingRef} className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-20">
          <div>
            ...
            >
              ...
              <span className="text-[10px] font-bold tracking-[0.3em] uppercase text-slate-400">Our Services</span>
            </motion.div>
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/services" className="text-sm text-slate-400 hover:text-slate-700 flex items-center gap-2 transition-colors duration-300 font-medium">
              View All Services
