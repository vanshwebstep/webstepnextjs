            ...
            <div className="lg:w-3/5">
              <div className="mb-10 text-center lg:text-left">
                ...
                <p className="text-slate-500 text-lg md:text-xl leading-relaxed mb-10 max-w-2xl">
                  We build native and cross-platform mobile applications that provide seamless user
                  experiences. Our expert team ensures your app is{" "}
                  <span className="text-slate-900 font-semibold">high-performing, secure, and scalable.</span>
                </p>
